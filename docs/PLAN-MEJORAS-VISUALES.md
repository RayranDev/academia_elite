...
| 2026-06-12 | **Sprint M completo** (M1–M10): fix simulador en vivo (CountUp), carta con 4 esquinas iguales, landing con `nino_carta.png`, filtro de escuela en usuarios, calendario del jugador, validación de progreso por el DT (masiva), carga masiva de jugadores por CSV + plantilla por escuela, umbrales de nivel editables, métricas configurables por escuela (`ParametroEscuela`), avatar DiceBear v10 toon-head con todas las opciones | ✅ lint/typecheck/87 unit/8 E2E en verde · build OK |
