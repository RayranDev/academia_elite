...
const NAV: NavItem[] = [
  ...
  { href: "/escuela/asistencia", label: "Asistencia", icon: "asistencia" },
  { href: "/escuela/ranking", label: "Ranking", icon: "ranking" },
  { href: "/escuela/membresias", label: "Membresías", icon: "membresias" },
